...
async def get_Buying_list(message):
    with open('img/1.jpg', 'rb') as img:
        await message.answer_photo(img, f"{texts.name_p1} \nОписание: {texts.about1} \nЦена: {texts.price1}")
    with open('img/2.jpg', 'rb') as img:
        await message.answer_photo(img, f"{texts.name_p2} \nОписание: {texts.about2} \nЦена: {texts.price2}")
    with open('img/3.jpg', 'rb') as img:
        await message.answer_photo(img, f"{texts.name_p3} \nОписание: {texts.about3} \nЦена: {texts.price3}")
    with open('img/4.jpeg', 'rb') as img:
        await message.answer_photo(img, f"{texts.name_p4} \nОписание: {texts.about4} \nЦена: {texts.price4}")
